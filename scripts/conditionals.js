...
if (homeWorkDone == true) {
    // it goes inside this place if the condition is true
    coffeeTime = 20;
} else {
    // it goes inside this place if the condition is false
    coffeeTime = 5;
}
...
function setWeather() {
    ...
    if (choice === "sunny") {
        // change the icon to sunny svg image
...
coffeeBreak ? breakMessage.textContent = "Yes! It's coffee time." : breakMessage.textContent = "No! I want coffee.";
